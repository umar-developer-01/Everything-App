...
import Image2 from "@/public/second-photo.jpg";
import Image3 from "@/public/third-photo.jpg";
import Image4 from "@/public/fourth-photo.jpg";
import Image5 from "@/public/fifth-photo.jpg";
...
const Body = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div>
        <Card image={BruceWayne} />
        <TextCard image={Image2} />
        <Card image={Image2} />
        <Card image={Image3} />
        <Card image={Image4} />
        <Card image={Image5} />
